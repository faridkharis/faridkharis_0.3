...
export default function Button({
  ...
  return (
    <button
      type={type}
      className={`${variant} px-5 py-2.5 rounded-lg font-medium whitespace-nowrap w-full md:w-max flex items-center justify-center hover:-translate-y-2 duration-300`}
    >
